# Training script for the sentiment RNN on the IMDB dataset.
# Mirrors TrainSentimentLSTM.py as closely as possible — both delegate the
...
SAVE_PATH     = os.path.join(SCRIPT_DIR, "trained", "SentimentRNN")
